...
$(function () {
  ...
  $.ajax({
    "async": false,
    "crossDomain": true,
    "url": "http://119.3.171.138:8082.info:21180/iot/api/dict/get",
    "method": "POST",
    "headers": {
...
function getEchartsName(area,e) {
  ...
  $.ajax({
    url: "http://119.3.171.138:8082/find",
    type: "post",
    dataType: "json",
    async: false,
    data: json,
...
function uploadFile(area) {
  ...
  if(base64Value==null||base64Value==""){
    ...
    $.ajax({
      //url:"http://119.3.171.138:8080.info:21081/report/excel/importReportTemple",
      //url:"http://192.168.3.210:8081/report/excel/importReportTemple",
      url:"http://119.3.171.138:8080/report/excel/importReportTemple",
      type:"post",
      dataType:"json",
      async:false,
      data:dataJson,
...
//             $.ajax({
//               url:"http://119.3.171.138:8080/uploadAll",
//               type:"post",
//               dataType:"json",
//               async:false,
//               data:{
...
function getModel_DS_WhichArea(area) {
  ...
  $.ajax({
    url:"http://119.3.171.138:8080/find",
    type:"post",
    dataType:"json",
    data:{
      "area":area,
