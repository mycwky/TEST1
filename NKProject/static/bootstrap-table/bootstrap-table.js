	...
	*/
	...
	var CONSTANTS = {
	  ...
	  4: {
	    ...
	    html: {
	      ...
	      pageDropdown: ['<ul class="dropdown-menu" style="width: 53px;background-color: #33435c;border: 0;">', '</ul>'],
	      pageDropdownItem: '<li class="dropdown-item %s" href="#" style="cursor: pointer"><a>%s</a></li>',
	...
	var EN = {
	  ...
	  formatRecordsPerPage: function formatRecordsPerPage(pageNumber) {
	    return "".concat("&nbsp;<span style='color: white'>每页显示</span>&nbsp;",pageNumber,"&nbsp;<span style='color: white'>行</span>");
	  },
	  formatShowingRows: function formatShowingRows(pageFrom, pageTo, totalRows, totalNotFiltered) {
	    if (totalNotFiltered !== undefined && totalNotFiltered > 0 && totalNotFiltered > totalRows) {
	      return "".concat("<span style='color:white;'>"+pageFrom, "<span style='color:white;'> / </span>").concat(pageTo, " ").concat(totalRows, " 共 ").concat(totalNotFiltered,"条</span>");
	    }

	    return "".concat("<span style='color: white'>"+pageFrom, " / ").concat(pageTo, "，共").concat(totalRows, " 条</span>");
	  },
	...
	function () {
	  ...
	  _createClass(BootstrapTable, [{
	    ...
	    value: function initPagination() {
	      ...
	      html.push("<div style='padding-left:30%' class=\"".concat(this.constants.classes.pull, "-").concat(o.paginationDetailHAlign, " pagination-detail\">\n      <span class=\"pagination-info\">\n      ").concat(paginationInfo, "\n      </span>"));

	      if (!o.onlyInfoPagination) {
	        html.push('<span class="page-list">');
	        var pageNumber = ["<span class=\"".concat(this.constants.classes.paginationDropdown, "\">\n        <button style='background-color:#33435c;color:white;border-color: #FFF;height: 32px;' class=\"").concat(this.constants.buttonsClass, " dropdown-toggle\" type=\"button\" data-toggle=\"dropdown\">\n        <span class=\"page-size\">\n        ").concat($allSelected ? o.formatAllRows() : o.pageSize, "\n        </span>\n        ").concat(this.constants.html.dropdownCaret, "\n        </button>\n        ").concat(this.constants.html.pageDropdown[0])];
